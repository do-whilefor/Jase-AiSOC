...
class Settings(BaseSettings):
    ...
    response_file_quarantine_root: str = "/var/lib/blue-team/response-quarantine"
    ...
    def require_complete_notification_webhook(self) -> Self:
        ...
        if configured:
            from blue_team.notification_engine.webhook import validate_webhook_destination
    ...
    def require_normalized_webhook_hosts(cls, value: tuple[str, ...]) -> tuple[str, ...]:
        from blue_team.notification_engine.webhook import normalize_webhook_host
