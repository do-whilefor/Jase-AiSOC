...
from blue_team.storage import Database, ObjectStore, agent_identity
from blue_team.storage.models import AgentEventRecord, AgentHeartbeatRecord, AuditLogRecord
...
def build_server_ssl_context(
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="blue-team-ingest-tls-"))
    try:
...
class IngestServer:
    ...
    async def start(self) -> None:
        ...
        ssl_context, temp_dir = build_server_ssl_context(self._signer, self._settings.ingest_host)
