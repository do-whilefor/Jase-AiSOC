...
class ReleaseInstaller:
    ...
    def _install_locked(
        ...
        *,
        ...
        if not secrets.compare_digest(payload_sha256, manifest.payload_sha256):
        ...
        if not secrets.compare_digest(manifest_sha256, verified.manifest_sha256):
    ...
    def _validate_deployment(
        ...
        *,
        ...
        for path, is_directory in _walk_release_tree(
            ...
            if require_hardened and os.name != "nt":
    ...
    *,
    ...
    for entry in sorted(root.iterdir(), key=lambda path: path.name):
        ...
        if stat.S_ISDIR(metadata.st_mode):
            if require_hardened and os.name != "nt" and stat.S_IMODE(metadata.st_mode) != 0o500:
