...
from blue_team.agent_core.installer import InstalledRelease

PROCESS_STARTED_MARKER: Final = b"BLUE_TEAM_AGENT_HEALTH_V1 STARTED"
PROCESS_HEALTHY_MARKER: Final = b"BLUE_TEAM_AGENT_HEALTH_V1 HEALTHY"

_MAX_ARGUMENTS = 256
_MAX_ARGUMENT_BYTES = 64 * 1024
_MAX_PROTOCOL_LINE_BYTES = 1024
_SAFE_ENVIRONMENT_NAME = re.compile(r"^[A-Za-z_][A-Za-z0-9_]{0,127}$")
_FORCE_SIGNAL: Final = signal.Signals(getattr(signal, "SIGKILL", signal.SIGTERM))
...
class InstalledReleaseProcessHealthCheck:
    ...
    executable_path: str = "bin/blue-team-agent"
