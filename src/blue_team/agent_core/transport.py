...
from blue_team.agent_core.contracts import AgentHeartbeat, BatchAck, EventBatch
...
class MtlsTransport:
    ...
    def __init__(
        ...
        *,
        ...
        self._temp_dir = Path(tempfile.mkdtemp(prefix="blue-team-transport-"))
        try:
            ...
            self._client = httpx.Client(timeout=timeout_seconds, verify=context)
        except Exception:
