...
from aisoc.agent_core.contracts import AgentHeartbeat
from aisoc.agent_core.queue import LocalDiskQueue, QueueConfig
from aisoc.agent_core.runtime import (
    AgentRuntime,
    AgentRuntimeState,
...
from aisoc.platform import CapabilityReport, LinuxPlatformAdapter
...
def _run_agent_process_locked(
    ...
    *,
    ...
    if config.auditd_enabled:
        ...
        from aisoc.agent_core.auditd_collector import AuditdCollector, AuditdCollectorConfig
    ...
    if config.journald_enabled:
        from aisoc.agent_core.journald_collector import (
            JournaldCollector,
    ...
    if config.suricata_enabled:
        from aisoc.agent_core.suricata_collector import (
            SuricataCollector,
    ...
    if config.service_log_enabled:
        from aisoc.agent_core.service_log_collector import (
            ServiceLogCollector,
