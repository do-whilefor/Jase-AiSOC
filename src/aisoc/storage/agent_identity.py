...
from aisoc.agent_core.enrollment import (
    enrollment_token_id,
...
from aisoc.domain import AgentEnrollmentRead
from aisoc.errors import AuthenticationError, ConflictError, NotFoundError
    ...
    if current is None:
        session.add(
            AgentSessionRecord(
                ...
                lease_digest=sha256_hex(value.encode("utf-8")),
        ...
        current.lease_digest = sha256_hex(value.encode("utf-8"))
...
async def renew_agent_session(
    ...
    *,
    ...
    if (
        ...
        or not secure_compare(
            sha256_hex(session_value.encode("utf-8")),
