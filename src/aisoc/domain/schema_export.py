...
from aisoc.agent_core.contracts import AgentEnvelope, AgentHeartbeat, BatchAck, EventBatch
...
from aisoc.domain.detection import DetectionRead
...
from aisoc.domain.malware import MalwareAnalysisReport, SignedSandboxReportEnvelope
